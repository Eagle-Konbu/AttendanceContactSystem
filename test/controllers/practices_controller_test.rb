...
class PracticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post practices_url, params: { practice: { date: @practice.date, name: @practice.name } }
    end
  ...
  test "should update practice" do
    patch practice_url(@practice), params: { practice: { date: @practice.date, name: @practice.name } }
